 ...
 */
@Entity
@Table(name = "KAS_IATRANSLOG", schema = "TYPE23", catalog = "")
public class KasIatranslogEntity {
    private long id;
    ...
    public boolean equals(Object o) {
        ...
        KasIatranslogEntity that = (KasIatranslogEntity) o;
        ...
        if (itemflag != null ? !itemflag.equals(that.itemflag) : that.itemflag != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (itemflag != null ? itemflag.hashCode() : 0);
